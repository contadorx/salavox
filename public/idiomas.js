...
(function () {
  ...
  const DIC = {
    ...
    "A gravação segue normal e a ata será feita inteira no fim.": "Recording carries on normally and the minutes will be produced in full at the end.",
    "A ideia": "The idea",
    ...
    "A transcrição ao vivo parou.": "Live transcription stopped.",
    ...
    "Agora escolha a janela da reunião e marque a opção de compartilhar o áudio…": "Now pick the meeting window and tick the option to share the audio…",
    ...
    "Nenhuma fonte de áudio. Ao compartilhar, marque \"compartilhar áudio\".": "No audio source. When sharing, tick \"share audio\".",
    ...
    "Não vai reunião nenhuma aqui dentro": "No meeting content goes in here",
    ...
    "On the graphics card the encoder comes uncompressed, which is why it is": "On the graphics card the encoder comes uncompressed, which is why it is",
    ...
    "Os fatos desta máquina, para colar num chamado.": "The facts about this machine, to paste into a support request.",
    ...
    "The first time, this path downloads": "The first time, this path downloads",
    "Tirar": "Remove",
    ...
    "Transcrito no": "Transcribed on the",
    ...
    "WebGPU indisponível — usando o processador.": "WebGPU unavailable — using the processor.",
    "When:": "When:",
    "YOU": "YOU",
    ...
    "gravar só o meu microfone": "record my microphone only",
    ...
    "the best text Whisper produces, and the only one in a different size league. Only choose it on a machine with room to spare.": "the best text Whisper produces, and the only one in a different size league. Only choose it on a machine with room to spare.",
    "the size of the processor path.": "the size of the processor path.",
    "transcrita": "transcribed",
    "tudo funciona assim mesmo": "everything works anyway",
    "usar a placa de vídeo": "use the graphics card",
    "vira": "becomes",
    ...
    "— a cada trinta segundos gravados aquele trecho já vira texto. Ao encerrar, quase toda a ata está pronta.": "— every thirty seconds recorded, that stretch already becomes text. By the time you stop, almost all the minutes are ready.",
    "— after that it is kept in the browser and is not downloaded again.": "— after that it is kept in the browser and is not downloaded again.",
    ...
    "— nem fala, nem título, nem participante.": "— no speech, no title, no participant.",
    "— o arquivo fica lá dentro": "— the file stays inside",
    "— o passo 2 vai aproveitá-las.": "— step 2 will make use of them.",
